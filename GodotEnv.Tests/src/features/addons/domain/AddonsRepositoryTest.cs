...
public class AddonsRepositoryTest {
  ...
  public async Task CacheAddonReturnsSymlinkAddonTargetWithSubfolder() {
    ...
    var onGitStdOut = new Mock<Action<string>>();
    var onGitStdErr = new Mock<Action<string>>();
  ...
  public async Task InstallAddonFromCacheCopiesCachedAddonToAddonsPath() {
    ...
    await repo.InstallAddonFromCache(
      addon,
      addon.Name,
      onGitStdOut.Object,
      onGitStdErr.Object
  ...
  public async Task UpdateCacheIgnoresSymlinkAddons() {
    ...
    await repo.UpdateCache(addon, cacheName, onGitStdOut.Object, onGitStdErr.Object);
  ...
  public async Task UpdateCacheCallsGitCorrectlyInAddonCacheLocation() {
    ...
    await repo.UpdateCache(
      addon, cacheName, onGitStdOut.Object, onGitStdErr.Object
    );
  ...
  public async Task PrepareCacheIgnoresSymlinkAddons() {
    ...
    await repo.PrepareCache(addon, cacheName, onGitStdOut.Object, onGitStdErr.Object);
